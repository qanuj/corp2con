...
app.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
    ...
    if (role == 'public') {
        ...
        .state('search', {
            url: "/search?starting&contractExtendable&contractToHire&keywords&companies&folder&page&skills&rateType&availables&functionals&consultantTypes&contractTypes&locations&experience&rates&industries&experienceStart&experienceEnd&rateStart&rateEnd",
            templateUrl: "app/views/" + role + "/search.html",
            data: { pageTitle: 'Search' },
            controller: role + "SearchController"
        })
